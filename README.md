...
To accomplish the stated objective, the following tasks were executed:
	...
	Integrated the MPU6050 IMU and implemented a pitch/roll attitude estimation algorithm using a complementary filter with a deterministic loop interval of Δt=4" ms"  (250 Hz).
